...
registerMarkdownLazyLineTests()
registerHTMLColumnWidthTests()
registerSerializerFallbackTests()
registerSerializationMutationKillTests()
registerHTMLImportPropertyTests()
registerHTMLImportMutationKillTests()
registerHTMLImportFitTests()
registerRTFImportPropertyTests()
registerRTFImportMutationKillTests()
registerBench()
