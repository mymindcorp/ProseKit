...
registerMathTests()
registerImageModelTests(); registerImageCommandTests(); registerImageBlockTests()
...
registerSearchTests()
registerSearchCoverageTests()
registerEditCoverageTests()
registerBoundaryCoverageTests()
registerModelCommandCoverageTests()
...
registerPMListTests()
registerListKeyboardCoverageTests(); registerPMTableMapTests(); registerPMTableCommandsTests(); registerPMCellCopyPasteTests(); registerPMTableExtraTests()
