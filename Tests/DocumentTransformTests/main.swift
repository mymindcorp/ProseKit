...
registerPMStructureTests(); registerPMTransformTests(); registerPMReplaceTests(); registerPMContentTests(); registerPMSliceTests(); registerPMMarkTests(); registerPMNodeTests(); registerPMMappingTests(); registerPMResolveTests(); registerPMStepTests(); registerPMDiffTests()
