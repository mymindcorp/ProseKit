...
#ifndef EDITORUIKIT_SWIFT_H
#define EDITORUIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EditorUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11EditorUIKit23DefaultTaskCheckboxView")
@interface DefaultTaskCheckboxView : UIView
...
@interface DefaultTaskCheckboxView (SWIFT_EXTENSION(EditorUIKit)) <UIPointerInteractionDelegate>
...
/// A lightweight, <em>read-only</em> view that renders a document with the shared
/// layout engine and <em>only draws the visible window</em>.
/// Pin it to a scroll view’s viewport and feed <code>contentOffsetY</code> to virtualize an
/// arbitrarily tall document (the same technique the editable <code>EditorTextView</code>
/// uses), or drop it in at its full <code>documentHeight</code> for short documents. Either
/// way, <code>draw(_:)</code> only paints the slice <code>[contentOffsetY, contentOffsetY + bounds.height]</code>, so cost is independent of document length.
SWIFT_CLASS("_TtC11EditorUIKit12DocumentView")
...
/// A UIKit view that renders an <code>Editor</code>’s document with CoreText and handles
...
SWIFT_CLASS("_TtC11EditorUIKit14EditorTextView")
@interface EditorTextView : UIView <UIKeyInput>
...
/// focus-engine <code>isFocused</code> to mean “is first responder” — the meaningful
...
/// in the class body — it overrides <code>UIView</code>’s method.)
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)gesture SWIFT_WARN_UNUSED_RESULT;
...
@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UIColorPickerViewControllerDelegate>
...
@class UIMenuElement;
@class UIMenu;
@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UIEditMenuInteractionDelegate>
- (UIMenu * _Nullable)editMenuInteraction:(UIEditMenuInteraction * _Nonnull)interaction menuForConfiguration:(UIEditMenuConfiguration * _Nonnull)configuration suggestedActions:(NSArray<UIMenuElement *> * _Nonnull)suggestedActions SWIFT_WARN_UNUSED_RESULT;
@end

@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UIGestureRecognizerDelegate>
/// Coexist with UITextInteraction’s own recognizers.
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gesture shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)other SWIFT_WARN_UNUSED_RESULT;
@end

@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UIPointerInteractionDelegate>
- (UIPointerRegion * _Nullable)pointerInteraction:(UIPointerInteraction * _Nonnull)interaction regionForRequest:(UIPointerRegionRequest * _Nonnull)request defaultRegion:(UIPointerRegion * _Nonnull)defaultRegion SWIFT_WARN_UNUSED_RESULT;
- (UIPointerStyle * _Nullable)pointerInteraction:(UIPointerInteraction * _Nonnull)interaction styleForRegion:(UIPointerRegion * _Nonnull)region SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UIDragInteractionDelegate, UIDropInteractionDelegate>
...
- (void)dragInteraction:(UIDragInteraction * _Nonnull)interaction session:(id <UIDragSession> _Nonnull)session didEndWithOperation:(UIDropOperation)operation;
...
@interface EditorTextView (SWIFT_EXTENSION(EditorUIKit)) <UITextInput>
...
- (void)unmarkText;
- (UITextRange * _Nullable)textRangeFromPosition:(UITextPosition * _Nonnull)from toPosition:(UITextPosition * _Nonnull)to SWIFT_WARN_UNUSED_RESULT;
